...
function o2(o3, n2, s2) {
  return void 0 === n2 && (n2 = {}), void 0 === s2 && (s2 = {}), function(a, i2, c) {
    try {
      return Promise.resolve(function(t, r2) {
        try {
          var u = (n2.context && true && console.warn("You should not used the yup options context. Please, use the 'useForm' context object instead"), Promise.resolve(o3["sync" === s2.mode ? "validateSync" : "validate"](a, Object.assign({ abortEarly: false }, n2, { context: i2 }))).then(function(t2) {
